...
from eval_util import getEvalArgs, iterate_multi_threaded, getSegments, contentToString, isNonemptyMsg, isGood, \
    breakUpChat
...
if args.eval_mode == "full":
    chatNames = [name for name in chatNames if datapack["chats"][name]["className"] == "positive"]
