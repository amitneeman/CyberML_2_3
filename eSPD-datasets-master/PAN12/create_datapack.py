...
def processDataset(datasetType, messageDatasetPath, predIDsPath):
    ...
    for chatObj in logsRoot:
        ...
        for messageObj in chatObj:
            ...
            if author is None:
                noAuthor += 1; continue  # never happens
            else:
    ...
    dprint("Number of messages with \n    noChatID %s, noMessageLine %s, noAuthor %s, noTime %s, noBodyCount %s" % (
    noChatID, noMessageLine, noAuthor, noTime, noBodyCount))
